...
public class CounselVO {
	...
	private String coun_consent;	// 상담 승인 여부
	
	private String stu_name;		// 학생 이름(조인 결과 저장)
	private String major_name;		// 학과명(조인 결과 저장)
	
	public static CounselVO conVo;
	
	public CounselVO() {

	}
	
	public CounselVO(String coun_id, String stu_id, String pro_id, String coun_type, String coun_date,
			String coun_content, String coun_consent, String stu_name, String major_name) {
		...
		this.coun_consent = coun_consent;
	...
	public String getCoun_consent() {
		return coun_consent;
	}

	public void setCoun_consent(String coun_consent) {
		this.coun_consent = coun_consent;
	}
	...
	public String toString() {
		return "CounselVO [coun_id=" + coun_id + ", stu_id=" + stu_id + ", pro_id=" + pro_id + ", coun_type="
				+ coun_type + ", coun_date=" + coun_date + ", coun_content=" + coun_content + ", coun_consent="
				+ coun_consent + ", stu_name=" + stu_name + ", major_name=" + major_name + "]";
	}
