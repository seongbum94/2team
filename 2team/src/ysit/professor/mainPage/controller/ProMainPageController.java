...
import ysit.professor.notice.controller.Pro_Notice_Controller;
...
public class ProMainPageController {
    ...
    @FXML
    void classOpClClick(MouseEvent event) throws IOException {
    	Parent ProSubject = FXMLLoader.load(getClass().getResource("../../subject/fxml/pro_sub.fxml"));
    	ProMainBorder.setCenter(ProSubject);
    }

    @FXML
    void clickJob(MouseEvent event) throws IOException {
    	Parent ProEmpBoard = FXMLLoader.load(getClass().getResource("../../emp/fxml/empBoard.fxml"));
    	ProMainBorder.setCenter(ProEmpBoard);
    }
    ...
    void clickNotice(MouseEvent event) throws IOException {
    	Parent ProNotice = FXMLLoader.load(getClass().getResource("../notice/fxml/pro_notice"));
    	ProMainBorder.setCenter(ProNotice);
    }
